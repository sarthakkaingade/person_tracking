...
static const std::string OPENCV_WINDOW = "Track Shirt Window";
...
public:
	...
	~TrackShirt() {cv::destroyWindow(OPENCV_WINDOW);} 
...
protected:
	...
	*/
	...
	void 	SelectTargetShirtCallback(const PerFoRoControl::SelectTarget msg);
